...
{
    public partial class ForPostgresConn : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailId = table.Column<string>(type: "character varying(75)", maxLength: 75, nullable: false),
                    Address = table.Column<string>(type: "character varying(75)", maxLength: 75, nullable: true),
                    PhoneNo = table.Column<string>(type: "character varying(75)", maxLength: 75, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductProfileId = table.Column<int>(type: "integer", nullable: true),
